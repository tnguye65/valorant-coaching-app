...
export default async function SessionDetailPage({
  ...
  const isOwner = session.student.id === currentUser.id;
  ...
  async function addQuestion(formData: FormData) {
    ...
    revalidatePath(`/student/sessions/${id}`);
  }
  ...
  return (
    <div className="p-10 max-w-7xl mx-auto">
      ...
      <Link
        href={
          isCoach ? `/coach/student/${session.studentId}` : "/student/dashboard"
        }
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-blue-600">Your Questions</CardTitle>
            </CardHeader>
              ...
              {isOwner && (
                <form action={addQuestion} className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      name="question"
                      placeholder="Ask your coach a question about this session..."
          ...
          <Card>
            ...
            <CardContent>
              {sessionNotes.length > 0 ? (
                <div className="space-y-4">
                  {sessionNotes.map((note, index: number) => (
                    <div
                      key={index}
                      className="border-l-4 border-green-500 pl-4 py-2 hover:bg-gray-50 rounded-r transition-colors"
                    >
                      ...
                      <p className="text-gray-800 leading-relaxed">
                        {note.answer || "No feedback provided yet."}
                      </p>
                    </div>
                  ))}
                </div>
